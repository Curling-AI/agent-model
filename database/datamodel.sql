...
-- Enum para status de assinatura (exatamente como no Supabase)
CREATE TYPE public.subscriptionstatus AS ENUM ('active', 'inactive', 'paused', 'expired');
...
-- Tabela User Subscriptions (exatamente como no Supabase)
...
-- Tabela User Subscriptions Payments (exatamente como no Supabase)
